    ...
    <div class="footer__head">
        <div class="container">
            <div class="row">
                ...
                <div class="footer__links col-sm-6 col-xs-6 col-md-2">
                    <ul>
                        <li class="link__head">Categories</li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Random</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Education</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Science</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Politics</a></li>
                    </ul>
                </div>
                <div class="footer__links col-sm-6 col-xs-6 col-md-2">
                    <ul>
                        <li class="link__head">Links</li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Blog</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Ask</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Experts</a></li>
                    </ul>
                </div>
